...
class LearnableBSplineActivation(nn.Module):
    def __init__(self, num_control_points=5, degree=3, start_point=-1, end_point=1, init_scale=1.0):
        ...
        # knot vector
        self.register_buffer('knots', torch.linspace(start_point, end_point, num_control_points + degree + 1))
